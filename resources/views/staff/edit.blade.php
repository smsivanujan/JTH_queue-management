...
@section('title', 'Edit Staff - SmartQueue')
            ...
            <div class="lg:col-span-1 space-y-4 sm:space-y-6">
                ...
                <div class="bg-white rounded-xl sm:rounded-2xl shadow-lg border-2 border-gray-200 p-4 sm:p-6 fade-in">
                    ...
                    <form action="{{ route('app.staff.reset-password', $staff) }}" method="POST" id="resetPasswordForm">
                        ...
                        <button type="submit" class="w-full px-4 py-2 bg-gradient-to-r from-amber-600 to-orange-600 text-white rounded-lg font-semibold hover:shadow-lg hover:scale-105 transition-all text-xs sm:text-sm touch-manipulation disabled:opacity-50 disabled:cursor-not-allowed" onclick="this.disabled=true; this.form.submit();">
                            Reset Password
                        </button>
                    </form>
                </div>
